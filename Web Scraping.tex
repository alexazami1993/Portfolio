...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{url} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{https://en.wikipedia.org/wiki/List\PYZus{}of\PYZus{}largest\PYZus{}companies\PYZus{}in\PYZus{}the\PYZus{}United\PYZus{}States\PYZus{}by\PYZus{}revenue}\PY{l+s+s1}{\PYZsq{}}
...
<td><a href="/wiki/Koch\_Industries" title="Koch Industries">Koch Industries</a>
</td>
<td>Conglomerate
</td>
...
<td><a class="mw-redirect" href="/wiki/Publix\_Super\_Markets" title="Publix Super
Markets">Publix Super Markets</a>
</td>
<td>Retail
</td>
...
<td><a href="/wiki/Winter\_Haven,\_Florida" title="Winter Haven, Florida">Winter
Haven, Florida</a>
</td></tr>
<tr>
<td>4
</td>
<td><a class="mw-redirect" href="/wiki/Mars,\_Incorporated" title="Mars,
Incorporated">Mars, Incorporated</a>
</td>
<td>Food industry
</td>
...
<td><a href="/wiki/Pilot\_Company" title="Pilot Company">Pilot Corporation</a>
</td>
...
<td><a href="/wiki/Knoxville,\_Tennessee" title="Knoxville, Tennessee">Knoxville,
Tennessee</a>
</td></tr>
<tr>
<td>6
...
<td><a class="mw-redirect" href="/wiki/San\_Antonio,\_Texas" title="San Antonio,
Texas">San Antonio, Texas</a>
</td></tr>
<tr>
<td>7
</td>
<td><a href="/wiki/Reyes\_Holdings" title="Reyes Holdings">Reyes Holdings</a>
</td>
...
<td><a href="/wiki/Rosemont,\_Illinois" title="Rosemont, Illinois">Rosemont,
Illinois</a>
</td></tr>
<tr>
<td>8
</td>
<td><a href="/wiki/C\%26S\_Wholesale\_Grocers" title="C\&amp;S Wholesale
Grocers">C\&amp;S Wholesale Grocers</a>
</td>
<td>Wholesaling
</td>
...
<td><a href="/wiki/Keene,\_New\_Hampshire" title="Keene, New Hampshire">Keene, New
Hampshire</a>
</td></tr>
<tr>
<td>9
</td>
<td><a href="/wiki/Enterprise\_Holdings" title="Enterprise Holdings">Enterprise
Holdings</a>
</td>
<td><a href="/wiki/Car\_rental" title="Car rental">Car rental</a>
</td>
<td style="text-align:center;">30
</td>
<td style="text-align:center;">80,000
</td>
<td><a href="/wiki/Clayton,\_Missouri" title="Clayton, Missouri">Clayton,
Missouri</a>
</td></tr>
<tr>
<td>10
...
<td><a class="mw-redirect" href="/wiki/Oklahoma\_City,\_Oklahoma" title="Oklahoma
City, Oklahoma">Oklahoma City, Oklahoma</a>
</td></tr></tbody></table>
<h2><span class="mw-headline" id="List\_of\_companies\_by\_profit">List of companies
by profit</span><span class="mw-editsection"><span class="mw-editsection-
bracket">[</span><a href="/w/index.php?title=List\_of\_largest\_companies\_in\_the\_Un
ited\_States\_by\_revenue\&amp;action=edit\&amp;section=3" title="Edit section: List
of companies by profit"><span>edit</span></a><span class="mw-editsection-
bracket">]</span></span></h2>
<p>The 10 most profitable companies in 2023 according to the Fortune 500.<sup
class="reference" id="cite\_ref-4"><a href="\#cite\_note-4">[4]</a></sup>
</p>
<table class="wikitable sortable">
<caption>
</caption>
...
<td><a href="/wiki/Apple\_Inc." title="Apple Inc.">Apple</a>
</td>
<td>Electronics
</td>
...
<td><a href="/wiki/Alphabet\_Inc." title="Alphabet Inc.">Alphabet</a>
</td>
<td>Technology
</td>
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{soup}\PY{o}{.}\PY{n}{find}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{table}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{class\PYZus{}} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{wikitable sortable}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<table class="box-More\_citations\_needed plainlinks metadata ambox ambox-content
ambox-Refimprove" role="presentation"><tbody><tr><td class="mbox-image"><div
class="mbox-image-div"><span typeof="mw:File"><a class="mw-file-description"
href="/wiki/File:Question\_book-new.svg"><img alt="" class="mw-file-element"
data-file-height="399" data-file-width="512" decoding="async" height="39"
src="//upload.wikimedia.org/wikipedia/en/thumb/9/99/Question\_book-new.svg/50px-
Question\_book-new.svg.png"
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{world\PYZus{}titles} \PY{o}{=} \PY{n}{soup}\PY{o}{.}\PY{n}{find\PYZus{}all}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{th}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{7}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
Empty DataFrame
Columns: [Rank, Name, Industry, Revenue (USD millions), Revenue growth,
Employees, Headquarters]
Index: []
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{column\PYZus{}data}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{:}
    ...
    \PY{n}{individual\PYZus{}row\PYZus{}data} \PY{o}{=} \PY{p}{[}\PY{n}{column\PYZus{}data}\PY{o}{.}\PY{n}{text}\PY{o}{.}\PY{n}{strip}\PY{p}{(}\PY{p}{)} \PY{k}{for} \PY{n}{column\PYZus{}data} \PY{o+ow}{in} \PY{n}{row\PYZus{}data}\PY{p}{]}
    \PY{c+c1}{\PYZsh{}print(individual\PYZus{}row\PYZus{}data)}
    \PY{n}{length} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{df}\PY{p}{)}
    \PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{n}{length}\PY{p}{]} \PY{o}{=} \PY{n}{individual\PYZus{}row\PYZus{}data}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
['100', 'Qualcomm', 'Technology', '44,200', '31.7\%', '51,000', 'San Diego,
California']
    \end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
   Rank                      Name                    Industry  \textbackslash{}
0     1                   Walmart                      Retail
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{o}{.}\PY{n}{to\PYZus{}csv}\PY{p}{(}\PY{n}{df}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/Users/hasibazami/Downloads/web\PYZus{}scraping}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df}\PY{o}{.}\PY{n}{to\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/Users/hasibazami/Downloads/web\PYZus{}scraping.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
